...
public class DynamicTextBuffer implements DynamicLinkedListImplementation {
    DynamicDoublyLinked textBuffer = new DynamicDoublyLinked();
    DynamicDoubleLinkedList headOfList = new DynamicDoubleLinkedList();
    int currentAddress;
    int firstLine = 1;
    int numberLine = 1;

    public void append(int line, DynamicDoubleLinkedList inputBuffer, int totalLine, int mainBufferLine){
        if(line==9999){
            DynamicNode temp = inputBuffer.head;
            if(temp!=null)
                textBuffer.insertFront(headOfList, temp.sb.toString());
            DynamicNode temp2 = headOfList.head;
            temp = temp.next;
            while(temp!=null){
    ...
    public void change(int line1, int line2, DynamicDoubleLinkedList inputBuffer, int totalLine, int mainBufferLine){
        if(line1==1 && line2==0){
    ...
    public void join(int line1, int line2, int mainBufferLine){
        ...
        if(line2>line1 && line2!=line1){
            DynamicNode temp = headOfList.head;
            DynamicNode temp2 = headOfList.head;
    ...
    public void move(int line1, int line2, int line3, int mainBufferLine){
        ...
        int index2 = line2;
        int index3 = line3;
        DynamicDoublyLinked tempList = new DynamicDoublyLinked();
        DynamicDoubleLinkedList tempHeadOfList = new DynamicDoubleLinkedList();
    ...
    public void printLine(int line1, int line2, DynamicDoubleLinkedList inputBuffer){
