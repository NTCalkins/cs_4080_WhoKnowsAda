...
namespace CS4080project.TextBufferDynamic
{
    class TextBufferDynamic
    {
        ...
        public unsafe void Append(uint line, DoubleLinkedList inputBuffer, uint totalLine, uint* mainbufferLine)
        {
            if(line == 9999)
            {
        ...
        public unsafe void Change(uint line1, uint line2, DoubleLinkedList inputBuffer, uint totalLine, uint* mainbufferLine)
        {
