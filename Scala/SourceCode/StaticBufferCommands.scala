...
class StaticBufferCommands() {

  //ONE BUFFER ONLY UNCOMMENTED AT ANY TIME. switch between using
  //Dynamic and static buffer using the below var buff
  
  //var buff: DynamicBuffer = new DynamicBuffer()

  var buff: StaticBuffer = new StaticBuffer()
...
object StaticBufferCommands {

  def main(args: Array[String]) = {
    val bc = new StaticBufferCommands
    var wfile : String = ""
